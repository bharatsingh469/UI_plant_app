...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    //abstract plant list from  plant model
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  // this container for search bar and mic
                  Container(
            ...
            // for list of type of plnt  under search bar
            Container(
            ...
            //list of category of plant card
            SizedBox(
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: IconButton(
                                  onPressed: () {
                                    setState(() {
                                      bool isFavouited = toggleIsFavorated(
            ...
            //containr for list of plant list
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 12),
